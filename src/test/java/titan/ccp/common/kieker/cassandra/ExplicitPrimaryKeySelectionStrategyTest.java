...
public class ExplicitPrimaryKeySelectionStrategyTest {
	...
	public void testClusteringColumnsWithVarargs() {
		...
		final Set<String> returnedClusteringColumns = this.strategy.selectClusteringColumns(EXAMPLE_TABLE_NAME, ImmutableList.of());
		assertEquals(ImmutableSet.of(EXAMPLE_CLUSTERING_COLUMN_1, EXAMPLE_CLUSTERING_COLUMN_2), returnedClusteringColumns);
	}

	@Test
	public void testClusteringColumnsWithCollection() {
		this.strategy.registerClusteringColumns(EXAMPLE_TABLE_NAME, ImmutableList.of(EXAMPLE_PARTITION_KEY_1, EXAMPLE_CLUSTERING_COLUMN_2));
		final Set<String> returnedClusteringColumns = this.strategy.selectClusteringColumns(EXAMPLE_TABLE_NAME, ImmutableList.of());
	...
	public void testRegisterPartitionKeysWithVarargs() {
		...
		final Set<String> returnedPartitionKeys = this.strategy.selectPartitionKeys(EXAMPLE_TABLE_NAME, ImmutableList.of());
	...
	public void testRegisterPartitionKeysWithCollection() {
		this.strategy.registerPartitionKeys(EXAMPLE_TABLE_NAME, ImmutableList.of(EXAMPLE_PARTITION_KEY_1, EXAMPLE_PARTITION_KEY_2));
		final Set<String> returnedPartitionKeys = this.strategy.selectPartitionKeys(EXAMPLE_TABLE_NAME, ImmutableList.of());
		assertEquals(ImmutableSet.of(EXAMPLE_PARTITION_KEY_1, EXAMPLE_PARTITION_KEY_2), returnedPartitionKeys);
	}
