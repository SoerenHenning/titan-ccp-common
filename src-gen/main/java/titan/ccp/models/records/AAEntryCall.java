 ...
 * @since 1.14
 */
public class AAEntryCall extends AbstractMonitoringRecord implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory {			
	/** Descriptive definition of the serialization size of the record. */
	public static final int SIZE = TYPE_SIZE_STRING // AAEntryCall.session
			 + TYPE_SIZE_LONG // AAEntryCall.entryTime
			 + TYPE_SIZE_LONG // AAEntryCall.exitTime
			 + TYPE_SIZE_STRING // AAEntryCall.operationSignature
			 + TYPE_SIZE_STRING; // AAEntryCall.componentSignature
	
	public static final Class<?>[] TYPES = {
		String.class, // AAEntryCall.session
		long.class, // AAEntryCall.entryTime
		long.class, // AAEntryCall.exitTime
		String.class, // AAEntryCall.operationSignature
		String.class, // AAEntryCall.componentSignature
	};
	...
	private static final long serialVersionUID = -6795892138482050976L;
	 ...
	 *            componentSignature
	 */
	public AAEntryCall(final String session, final long entryTime, final long exitTime, final String operationSignature, final String componentSignature) {
	 ...
	 *
	 * @deprecated since 1.13. Use {@link #AAEntryCall(IValueDeserializer)} instead.
	 */
	@Deprecated
	public AAEntryCall(final Object[] values) { // NOPMD (direct store of values)
	 ...
	 */
	@Deprecated
	protected AAEntryCall(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values stored directly)
	 ...
	 */
	public AAEntryCall(final IValueDeserializer deserializer) throws RecordInstantiationException {
	...
	public boolean equals(final Object obj) {
		...
		final AAEntryCall castedRecord = (AAEntryCall) obj;
