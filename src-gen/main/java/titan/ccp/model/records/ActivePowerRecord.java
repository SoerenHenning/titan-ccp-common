...
public class ActivePowerRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3417578451401129174L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ActivePowerRecord\",\"namespace\":\"titan.ccp.model.records\",\"fields\":[{\"name\":\"identifier\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"*\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"*\"},{\"name\":\"valueInW\",\"type\":\"double\",\"doc\":\"*\"}]}");
   ...
   */
  public static titan.ccp.model.records.ActivePowerRecord.Builder newBuilder() {
    return new titan.ccp.model.records.ActivePowerRecord.Builder();
  }
   ...
   * @return A new ActivePowerRecord RecordBuilder
   */
  public static titan.ccp.model.records.ActivePowerRecord.Builder newBuilder(titan.ccp.model.records.ActivePowerRecord.Builder other) {
    if (other == null) {
      return new titan.ccp.model.records.ActivePowerRecord.Builder();
    } else {
      return new titan.ccp.model.records.ActivePowerRecord.Builder(other);
    }
  }
   ...
   * @return A new ActivePowerRecord RecordBuilder
   */
  public static titan.ccp.model.records.ActivePowerRecord.Builder newBuilder(titan.ccp.model.records.ActivePowerRecord other) {
    if (other == null) {
      return new titan.ccp.model.records.ActivePowerRecord.Builder();
    } else {
      return new titan.ccp.model.records.ActivePowerRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ActivePowerRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(titan.ccp.model.records.ActivePowerRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(titan.ccp.model.records.ActivePowerRecord other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.identifier)) {
        this.identifier = data().deepCopy(fields()[0].schema(), other.identifier);
    ...
    /**
      ...
      * @return This builder.
      */
    public titan.ccp.model.records.ActivePowerRecord.Builder setIdentifier(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public titan.ccp.model.records.ActivePowerRecord.Builder clearIdentifier() {
      identifier = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public titan.ccp.model.records.ActivePowerRecord.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public titan.ccp.model.records.ActivePowerRecord.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public titan.ccp.model.records.ActivePowerRecord.Builder setValueInW(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public titan.ccp.model.records.ActivePowerRecord.Builder clearValueInW() {
